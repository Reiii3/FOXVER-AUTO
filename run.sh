...
local url_ui_full="https://raw.githubusercontent.com/Reiii3/FOXVER-AUTO/dev/engine/sys_ui/ui_full.sh"
local url_ui_beta="https://raw.githubusercontent.com/Reiii3/FOXVER-AUTO/dev/engine/sys_ui/beta_ui.sh"
local url_engine="https://raw.githubusercontent.com/Reiii3/FOXVER-AUTO/dev/engine/core-engine.sh"
local url_prop="https://raw.githubusercontent.com/Reiii3/FOXVER-AUTO/dev/bin/prop.sh"
local url_fun="https://reiii3.github.io/Center-Module/core-system/function.sh"
local url_change="https://raw.githubusercontent.com/Reiii3/FOXVER-AUTO/dev/bin/changelogs.sh"
local url_maintenance="https://raw.githubusercontent.com/Reiii3/FOXVER-AUTO/dev/bin/maintenance.sh"
local url_main="https://raw.githubusercontent.com/Reiii3/FOXVER-AUTO/dev/engine/engine_main.sh"
local url_ai_reboot="https://raw.githubusercontent.com/Reiii3/FOXVER-AUTO/dev/engine/core/reboot-ai.sh"
...
if [ $ui_mod = false ]; then
  local cek_ui=$(storm "https://raw.githubusercontent.com/Reiii3/FOXVER-AUTO/dev/engine/user/beta_ui.txt")
fi
if [ $dev_mode = true ]; then
  local cek_akses=$(storm "https://raw.githubusercontent.com/Reiii3/FOXVER-AUTO/dev/engine/user/beta_akses.txt")
fi
